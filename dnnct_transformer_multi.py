...
parser.add_argument('--model_type', type=str, default="origin", help='Type of the model use origin or qnn')
parser.add_argument('--first_n_img', type=int, default=30, help='Number of first images to process')
...
if __name__ == "__main__":
    ...
    inputs = fashion_mnist_transformer_shap(model_name,ton_n_shap_list=ton_n_shap_list ,first_n_img=first_n_img,model_type=model_type,delta_factor=delta_factor)
